 ...
 *** When game starts ***
 ****************************************************/
console.log("Help the poor Nyan Cat instead of looking into the console :( (This is an easter egg)")
...
let audio = new Audio(src= "img/Cat.mp3")
...
function playNyan() {
 ...
 Music.addEventListener("click",playNyan)